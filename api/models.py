...
#     servicio_paciente_id = models.ForeignKey('ServiciosHospitalarios', models.DO_NOTHING, db_column='Servicio_Paciente_ID')  # Field name made lowercase.
#     departamento_solicitante = models.ForeignKey('Departamento', models.DO_NOTHING, db_column='Departamento_Solicitante')  # Field name made lowercase.
...
#     class Meta:
#         managed = False
#         db_table = 'api_aprobacionesservicios'
...
#     descripcion = models.CharField(db_column='Descripcion', max_length=500)  # Ajuste de longitud máxima
#     fecha_hora = models.DateTimeField(db_column='Fecha_Hora')

#     class Meta:
#         managed = False
#         db_table = 'api_bitacoradg'


# class Departamento(models.Model):
#     nombre = models.CharField(db_column='Nombre', max_length=100)  # Field name made lowercase.
#  # area_medica_id = models.ForeignKey(AreaMedica, models.DO_NOTHING, db_column='AreaMedica_id', blank=True, null=True)  # Field name made lowercase.
#     area_medica = models.ForeignKey('AreaMedica', on_delete=models.SET_NULL, null=True, blank=True)
...
#     departamento_id = models.ForeignKey(Departamento, models.DO_NOTHING, db_column='Departamento_id')  # Field name made lowercase.   
#     instalacion_superior_id = models.ForeignKey('self', models.DO_NOTHING, db_column='Instalacion_superior_id', blank=True, null=True)  # Field name made lowercase.
#     estatus = models.CharField(db_column='Estatus', max_length=17, blank=True, null=True)  # Field name made lowercase.

#     class Meta:
#         managed = False
#         db_table = 'api_serviciosmedicos'


# class PacientesHG(models.Model):
#     persona_id = models.OneToOneField('Persona', models.DO_NOTHING, db_column='Persona_ID', primary_key=True)  # Field name made lowercase.
...
# class PersonalMedico(models.Model):
#     persona = models.OneToOneField('Persona', models.DO_NOTHING, db_column='Persona_ID', primary_key=True)  # Field name made lowercase.
...
#     tipo_intervencion = models.CharField(db_column='Tipo_Intervencion', max_length=22, blank=True, null=True)
#     descripcion = models.TextField(db_column='Descripcion', blank=True, null=True)
#     departamento_responsable_id = models.ForeignKey(Departamento, on_delete=models.DO_NOTHING, db_column='Departamento_Responsable_ID', related_name='servicios_hospitalarios')
#     estatus = models.BooleanField(default=True)

#     class Meta:
#         managed = False
#         db_table = 'api_servicioshospitalarios'
