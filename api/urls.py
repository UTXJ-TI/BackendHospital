...
router.register(r'Departamentos', views.DepartamentoServiciosViewSet)
router.register(r'AreaMedica', views.AreaMedicaServiciosViewSet)
router.register(r'PersonalMedico', views.PersonalMedicoServiciosViewSet)
router.register(r'Personas', views.PersonaServiciosViewSet)
router.register(r'Pacientes', views.PacientesHGServiciosViewSet)
